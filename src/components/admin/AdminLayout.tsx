...
import { Calendar, CalendarDays, CreditCard, Home, Image as ImageIcon, Inbox, LayoutDashboard, LogOut, Package, ReceiptText, Tag, Type, UtensilsCrossed } from "lucide-react";
...
const items: NavItem[] = [
  ...
  { to: "/admin/bills", label: "Extra bills", icon: CreditCard },
  ...
  { to: "/admin/restaurant-menu", label: "Restaurant menu", icon: UtensilsCrossed },
